...
switch (yykind)
    ...
    struct symbol_type : basic_symbol<by_kind>
    {
...
#endif
      {
        YY_ASSERT (tok == token::YYEOF
                   || (token::YYerror <= tok && tok <= token::REG));
      }
#if 201103L <= YY_CPLUSPLUS
...
#endif
      {
        YY_ASSERT ((token::OPCODE <= tok && tok <= token::OPTION));
      }
    };
    ...
    // Implementation of make_symbol for each symbol type.
      ...
      static
      symbol_type
      make_OPCODE (string v, location_type l)
      {
        return symbol_type (token::OPCODE, std::move (v), std::move (l));
      }
#else
      static
      symbol_type
      make_OPCODE (const string& v, const location_type& l)
      {
      ...
      {
        return symbol_type (token::OPTION, std::move (v), std::move (l));
      }
#else
      static
      symbol_type
      ...
      {
        return symbol_type (token::OPTION, v, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
